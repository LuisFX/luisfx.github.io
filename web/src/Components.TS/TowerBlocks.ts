// Since we're having issues with imports, we'll use global declaration instead
// These libraries will be loaded via script tags in the component
...
class Game
{
	...
	{
		for(let key in Game.STATES) this.mainContainer.classList.remove(Game.STATES[key]);
